...
if(_curTarget isKindOf "House_F" && {player distance _curTarget < 12} OR ((nearestObject [[15794,16613.5,0],"Land_Dome_Small_F"]) == _curTarget OR (nearestObject [[15794,16621.3,0],"Land_Research_house_V1_F"]) == _curTarget)) exitWith {
