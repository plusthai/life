...
class VirtualItems {
	...
	VITEMMACRO(handcuffs, "STR_Item_Handcuffs", "handcuffs", 1, 150, 75, false, -1, "")
	VITEMMACRO(handcuffkeys, "STR_Item_Handcuffkeys", "handcuffkeys", 1, 150, 75, false, -1, "")	
	VITEMMACRO(goldbar, "STR_Item_GoldBar", "goldBar", 12, -1, 40000, false, -1, "")
	...
	VITEMMACRO(storagebig, "STR_Item_StorageBL", "storageBig", 10, 500000, -1, false, -1, "icons\ico_storageBig.paa")

	//Mined Items
	VITEMMACRO(oil_unprocessed, "STR_Item_OilU", "oilUnprocessed", 7, -1, -1, false, -1, "")
	VITEMMACRO(oil_processed, "STR_Item_OilP", "oilProcessed", 6, -1, 4200, false, -1, "")
	...
	VITEMMACRO(iron_refined, "STR_Item_IronIngot", "ironRefined", 3, -1, 4200, false, -1, "")
	VITEMMACRO(salt_unrefined, "STR_Item_Salt", "saltUnrefined", 3, -1, -1, false, -1, "")
	VITEMMACRO(salt_refined, "STR_Item_SaltR", "saltRefined", 1, -1, 2450, false, -1, "")
	VITEMMACRO(sand, "STR_Item_Sand", "sand", 3, -1, -1, false, -1, "")
	VITEMMACRO(glass, "STR_Item_Glass", "glass", 1, -1, 2450, false, -1, "")
	VITEMMACRO(diamond_uncut, "STR_Item_DiamondU", "diamondUncut", 4, -1, 750, false, -1, "")
	VITEMMACRO(diamond_cut, "STR_Item_DiamondC", "diamondCut", 2, -1, 6000, false, -1, "")
	VITEMMACRO(rock, "STR_Item_Rock", "rock", 6, -1, -1, false, -1, "")
	VITEMMACRO(cement, "STR_Item_CementBag", "cement", 5, -1, 2950, false, -1, "")
	VITEMMACRO(platinum_unprocessed, "STR_Item_platiNumU", "platinumUnprocessed", 10, -1, -1, false, -1, "")
	VITEMMACRO(platinum_processed, "STR_Item_platiNumP", "platinumProcessed", 5, -1, 8000, true, -1, "")
	
	//Drugs
	VITEMMACRO(heroin_unprocessed, "STR_Item_HeroinU", "heroinUnprocessed", 6, -1, -1, true, -1, "")
	VITEMMACRO(heroin_processed, "STR_Item_HeroinP", "heroinProcessed", 4, 9000, 7500, true, -1, "")
	VITEMMACRO(cannabis, "STR_Item_Cannabis", "cannabis", 4, -1, -1, true, -1, "")
	VITEMMACRO(marijuana, "STR_Item_Marijuana", "marijuana", 3, 8800, 7000, true, -1, "icons\ico_marijuana.paa")
	VITEMMACRO(cocaine_unprocessed, "STR_Item_CocaineU", "cocaineUnprocessed", 6, -1, 3000, true, -1, "")
	VITEMMACRO(cocaine_processed, "STR_Item_CocaineP", "cocaineProcessed", 4, -1, 9000, true, -1, "")
	...
	//Food
	VITEMMACRO(apple, "STR_Item_Apple", "apple", 1, 100, 70, false, 10, "icons\food.paa")
	VITEMMACRO(peach, "STR_Item_Peach", "peach", 1, 150, 80, false, 10, "icons\food.paa")
...
class Licenses {
	...
	LICENSEMACRO(platinum,"STR_License_Platinum","platinum",30000,false,"civ")
	LICENSEMACRO(Taxi,"STR_License_Taxi","Taxi",1000000,false,"civ")
	LICENSEMACRO(News,"STR_License_News","News",1000000,false,"civ")
};
...
class VirtualShops {
	...
	class jewellers {
		name = "STR_Item_PlatiNum";
		items[] = { "platinum_processed" };
	};
