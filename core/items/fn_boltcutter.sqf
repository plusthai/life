...
if((nearestObject [[15794.676,15794.676,0],"Land_Dome_Small_F"]) == _building OR (nearestObject [[15794,16613.3,0],"Land_Research_house_V1_F"]) == _building) then {
