...
switch (_var) do
{
	...
	case "life_inv_platinumu": {(localize "STR_Item_platinumU")};
	case "life_inv_platinump": {(localize "STR_Item_platinumP")};	
	...
	case "license_civ_platinum": {(localize "STR_License_Platinum")};
